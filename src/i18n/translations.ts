export const translations = {
  en: {
    ...
    projects: {
      title: 'Our Projects',
      subtitle: 'Explore our collection of ready-to-deploy web applications',
      filter: {
        all: 'All Projects',
    ...
    footer: {
      description: 'Building modern web applications that drive business success.',
  ...
  fr: {
    ...
    projects: {
      title: 'Nos Projets',
      subtitle: 'Découvrez notre collection d\'applications web prêtes à déployer',
      filter: {
    ...
    contact: {
      ...
      subtitle: 'Vous avez un projet en tête? Discutons de la façon dont nous pouvons aider votre entreprise à se développer',
      form: {
        name: 'Votre Nom',
        email: 'Adresse Email',
        subject: 'Sujet',
    ...
    footer: {
      description: 'Créer des applications web modernes qui favorisent le succès commercial.',
  ...
  ar: {
    ...
    projects: {
      title: 'مشاريعنا',
      subtitle: 'استكشف مجموعتنا من تطبيقات الويب الجاهزة للنشر',
      filter: {
        all: 'جميع المشاريع',
    ...
    contact: {
      title: 'تواصل معنا',
      subtitle: 'هل لديك مشروع في ذهنك؟ دعنا نناقش كيف يمكننا مساعدة عملك على النمو',
      form: {
        name: 'اسمك',
    ...
    footer: {
      description: 'بناء تطبيقات ويب حديثة تدفع نجاح الأعمال.',

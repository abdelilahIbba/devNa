    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-2 space-y-8">
          ...
          <div class="relative rounded-2xl overflow-hidden shadow-2xl group border border-slate-800">
            ...
            <div class="absolute top-6 left-6 flex flex-wrap gap-2 z-20">
              <span 
                ...
                :key="tag"
                class="px-4 py-2 bg-slate-900/90 backdrop-blur-sm text-sm font-semibold text-blue-400 rounded-full shadow-lg border border-slate-700"
              >
                {{ tag }}
              </span>
            </div>
          ...
          <div>
            <h1 class="text-4xl sm:text-5xl font-bold text-white mb-4">{{ project.title }}</h1>
            <p class="text-lg text-slate-400 leading-relaxed">{{ project.fullDescription }}</p>
          </div>
          ...
          <div class="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 shadow-lg">
            ...
            <div class="flex flex-wrap gap-3">
              <span 
                ...
                :key="tech"
                class="px-4 py-2 bg-slate-800/50 text-blue-400 font-medium rounded-lg border border-blue-500/20 hover:border-blue-500/50 transition-colors"
              >
                {{ tech }}
              </span>
            </div>
          ...
          <div class="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 shadow-lg">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div 
                ...
                :key="index"
                class="aspect-video bg-slate-800 rounded-lg overflow-hidden group cursor-pointer border border-slate-700 hover:border-blue-500/50 transition-colors"
              >
                <img 
                  :src="screenshot"
        ...
        <div class="space-y-6">
          ...
          <div class="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 shadow-lg sticky top-24">
            <div class="text-center mb-6">
              ...
              <div class="text-sm text-slate-500">one-time payment</div>
            </div>
            ...
            <div class="mt-6 pt-6 border-t border-slate-700">
              <div class="text-sm text-slate-500 mb-3">Need customization?</div>
              <router-link 
                to="/contact"
                class="flex items-center justify-center space-x-2 text-blue-400 font-medium hover:text-blue-300 transition-colors"
              >
          ...
          <div class="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-6 shadow-lg">
            ...
            <div class="space-y-3">
              <div class="flex justify-between items-center">
                ...
                <span class="text-sm font-semibold text-white">{{ project.category }}</span>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-sm text-slate-500">Downloads</span>
                <span class="text-sm font-semibold text-white">150+</span>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-sm text-slate-500">Rating</span>
                <span class="text-sm font-semibold text-white">4.9/5.0</span>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-sm text-slate-500">Last Updated</span>
                <span class="text-sm font-semibold text-white">Dec 2025</span>
              </div>
            </div>
          </div>
        </div>

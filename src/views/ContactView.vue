  ...
  <div class="min-h-screen bg-slate-950 pt-24 pb-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
              ...
              <div>
                ...
                <input 
                  ...
                  v-model="form.name"
                  required
                  class="w-full px-4 py-3 rounded-lg bg-slate-800 border border-slate-700 text-white placeholder-slate-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none"
              ...
              <div>
                ...
                <textarea 
                  ...
                  required
                  rows="6"
                  class="w-full px-4 py-3 rounded-lg bg-slate-800 border border-slate-700 text-white placeholder-slate-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none resize-none"
        ...
        <div class="space-y-6">
          <!-- WhatsApp Card -->
          <div class="bg-gradient-to-br from-green-600 to-green-800 rounded-2xl shadow-lg p-8 text-white border border-green-500/30">
          ...
          <div class="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl shadow-lg p-8">
            ...
            <div class="grid grid-cols-3 gap-3">
              <a href="#" class="aspect-square bg-slate-800 hover:bg-blue-600/20 rounded-lg flex items-center justify-center transition-colors group">
          ...
          <!-- Availability -->
          <div class="bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl shadow-lg p-8 text-white border border-blue-400/30">

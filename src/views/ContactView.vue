    ...
    <div class="page-container">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-2">
          <div class="surface-inset rounded-lg shadow-lg p-8">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
              <!-- Name -->
              <div>
                <label for="name" class="block text-sm font-medium text-[#c8d0dc] mb-2">
                  {{ t.contact.form.name }} *
                </label>
                <input 
                  type="text"
                  ...
                  v-model="form.name"
                  required
                  class="w-full px-4 py-3 rounded-lg bg-[#070b1c] border border-[#1a2740] text-white placeholder-slate-500 focus:ring-2 focus:ring-[#00c2ff] focus:border-transparent transition-all outline-none"
              ...
              <!-- Email -->
              <div>
                <label for="email" class="block text-sm font-medium text-[#c8d0dc] mb-2">
              ...
              <!-- Subject -->
              <div>
                <label for="subject" class="block text-sm font-medium text-[#c8d0dc] mb-2">
              ...
              <!-- Message -->
              <div>
                <label for="message" class="block text-sm font-medium text-[#c8d0dc] mb-2">
                ...
                <textarea 
                  ...
                  required
                  rows="6"
                  class="w-full px-4 py-3 rounded-lg bg-[#070b1c] border border-[#1a2740] text-white placeholder-slate-500 focus:ring-2 focus:ring-[#00c2ff] focus:border-transparent transition-all outline-none resize-none"
              ...
              <button 
                type="submit"
                :disabled="isSending"
                class="w-full px-8 py-4 bg-[#00c2ff] hover:brightness-105 disabled:opacity-50 disabled:cursor-not-allowed text-[#010217] rounded-lg font-semibold transition-all duration-300 flex items-center justify-center space-x-2"
              >
        ...
        <div class="space-y-6">
          <!-- WhatsApp Card -->
          <div class="bg-gradient-to-br from-emerald-700 to-emerald-900 rounded-lg shadow-lg p-8 text-white border border-green-500/30">
            ...
            <p class="text-green-100 mb-4 text-sm">Get instant answers via WhatsApp</p>
            <a 
              href="https://wa.me/2120702627922"
              target="_blank"
              class="inline-flex items-center px-6 py-3 bg-white text-green-700 rounded-full font-semibold hover:bg-green-50 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              <span>Chat Now</span>
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@devna.it" class="text-white font-medium hover:text-blue-400 transition-colors">
                    contact@devna.it
                  </a>
                </div>
              </div>
              ...
              <div class="flex items-start space-x-4">
                ...
                <div>
                  <div class="text-sm text-slate-500 mb-1">Phone</div>
                  <a href="tel:+212XXXXXXXXX" class="text-white font-medium hover:text-blue-400 transition-colors">
                    +212 XXX-XXXXXX
                  </a>
                </div>
              </div>
          ...
          <div class="surface-inset rounded-lg shadow-lg p-8">
            ...
            <div class="grid grid-cols-3 gap-3">
              <a href="#" class="aspect-square bg-[#0c1224] hover:bg-[#00c2ff]/15 rounded-lg flex items-center justify-center transition-colors group">
                <svg class="w-6 h-6 text-[#9aa8bc] group-hover:text-blue-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Availability -->
          <div class="rounded-lg shadow-lg p-8 text-[#010217] border border-[#00c2ff]/40 bg-gradient-to-br from-[#0096e0] to-[#00c2ff]">
